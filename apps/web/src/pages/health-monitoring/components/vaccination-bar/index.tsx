...
const VaccinationBar = () => {
  ...
  const vaccineOptions = ["Anti-MERS", "Anti-COVID", "Anti-Flu", "Anti-Rabies"];

  return (
    <div
      className="w-full mx-auto p-2"
      style={{ backgroundColor: "#116C2B", borderRadius: "10px" }}
    >
      <div className="flex justify-center">
        <div
          className="w-52 border border-white"
          style={{ backgroundColor: "#116C2B" }}
        >
          <Select
          ...
          >
            <SelectTrigger style={{ color: "white", borderRadius: "0" }}>
              <SelectValue>{selectedVaccine}</SelectValue>
            </SelectTrigger>
