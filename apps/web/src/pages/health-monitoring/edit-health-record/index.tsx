...
function EditHealthRecord() {
  ...
  const { data: healthRecord, isLoading, error } = useHealthRecordById(healthRecordId!);
  ...
  if (error || !healthRecord) {
    return (
      <div className="flex flex-col items-center justify-center h-full">
        <h2 className="text-2xl font-bold text-red-600 mb-4">Health Record Not Found</h2>
        <p className="text-gray-600 mb-6">The health record you're looking for doesn't exist or has been deleted.</p>
